...
2. Customise the environment, putting in the name of your Chromecast Audio and the IP of your smart plug; optionally change the idle time or remove the line to have the default of 60 seconds.
